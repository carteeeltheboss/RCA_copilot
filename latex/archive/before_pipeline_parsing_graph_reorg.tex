...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[archlabel] at (11.55,6.22) {MSI future AI system};
  ...
  \node[futureitem,minimum width=1.45cm] (chroma) at (3.05,.77) {ChromaDB};
  ...
  \node[futureitem,minimum width=1.05cm] (ollama) at (10.98,1.55) {Ollama};
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[ffuture,minimum width=1.15cm] (chroma3) at (7.35,3.65) {ChromaDB};
  ...
  \node[ffuture,minimum width=1.05cm] (ollama3) at (7.75,2.12) {Ollama};
