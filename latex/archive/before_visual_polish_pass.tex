...
\tikzset{
  ...
  eventInfo/.style={circle,draw=MediumBlue,very thick,fill=SoftBlue,text=DeepNavy,font=\small,align=center,minimum size=.76cm},
  eventWarn/.style={circle,draw=Amber,very thick,fill=SoftAmber,text=DeepNavy,font=\small,align=center,minimum size=.76cm},
  eventErr/.style={circle,draw=MutedRed,very thick,fill=SoftRed,text=DeepNavy,font=\small,align=center,minimum size=.76cm},
  eventDebug/.style={circle,draw=Slate,very thick,fill=SoftSlate,text=DeepNavy,font=\small,align=center,minimum size=.76cm},
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[miniartifact,minimum width=3.25cm] (example) at (2.25,.84) {journalctl -o json\\ERROR nova.compute\\Build failed: instance 48f...};
  \node[miniartifact,minimum width=3.30cm] (fields) at (6.20,.84) {level = ERROR\\service = nova-compute\\resource = instance 48f...};
  \node[eventErr] (n1) at (9.70,.84) {E};
  \node[miniartifact,minimum width=1.85cm] (version) at (11.15,.84) {parser-v1\\source raw ID};
...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[zone,minimum width=5.45cm,minimum height=1.92cm] at (3.40,1.70) {};
  \node[smalltitle] at (3.40,2.45) {Graph safety rules};
  \node[ok,minimum width=2.12cm] at (2.05,1.90) {consecutive\\edges only};
  \node[ok,minimum width=2.12cm] at (4.80,1.90) {max group\\size};
  \node[ok,minimum width=2.12cm] at (2.05,1.05) {periodic groups\\skipped};
  \node[ok,minimum width=2.12cm] at (4.80,1.05) {avoid O(n\textsuperscript{2})\\explosion};

  \node[zone,minimum width=5.45cm,minimum height=1.92cm] at (9.40,1.70) {};
  \node[smalltitle] at (9.40,2.45) {Relationship legend};
  \node[eventInfo] at (7.55,1.95) {};
  \node[note,anchor=west,text width=3.45cm] at (8.05,1.95) {Node = parsed event};
  \draw[edgeReq] (7.25,1.38) -- (7.95,1.38);
  \node[note,anchor=west,text width=3.45cm] at (8.05,1.38) {Purple = same request ID};
  \draw[edgeRes] (7.25,.82) -- (7.95,.82);
  \node[note,anchor=west,text width=3.45cm] at (8.05,.82) {Teal = shared resource ID};

  \node[font=\bfseries\small,text=Amber,align=center] at (6.40,.22) {Edges are correlation, not causality};
\end{tikzpicture}
\end{frame}
